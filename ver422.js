...
var buttonvol = '0.3'
var buttonsounds = 'https://lisikme.github.io/ketame-fm-webview/web/sounds/sfx4.mp3'
var selectsounds = 'https://lisikme.github.io/ketame-fm-webview/web/sounds/sfx3.mp3'
var selectsfx = 'https://lisikme.github.io/ketame-fm-webview/web/sounds/sfx4.mp3'
...
$(function () {
  ...
  var result = ''; var i = -4; do {i += 5; {
    ...
    sell.innerHTML = (`<img id=immm src="https://lisikme.github.io/ketame-fm-webview/web/${fm_list[i]}"><span id=names>${fm_list[i-1]}</span><span id=stat>${fm_list[i+2]}</span> <span id=nums>${((i-1)/5)+1}</span>`)
...
var playerTrack=$("#player-track"),
    ...
    buffInterval = setInterval(function() {
      if (nTime == 0 || bTime - nTime > 1000) {
        ...
        if (errs && !lastErrState) {
          var sound = new Audio('https://lisikme.github.io/ketame-fm-webview/web/sounds/sfx8.mp3');
          sound.volume = buttonvol;
          sound.play();
        }
      } else {
  ...
  function selectTrack(flag) {
    ...
    if (currIndex > -1 && currIndex < fm_list.length) {
      ...
      bgback.css({ "background-image": "url(" + 'https://lisikme.github.io/ketame-fm-webview/web/'+currImage + ")" });
      bglogo.css({ "background-image": "url(" + 'https://lisikme.github.io/ketame-fm-webview/web/'+currImage + ")" });
      bglogo1.css({ "background-image": "url(" + 'https://lisikme.github.io/ketame-fm-webview/web/'+currImage + ")" });
      bglogobg.css({ "background-image": "url(" + 'https://lisikme.github.io/ketame-fm-webview/web/'+currImage + ")" });
    } else {
      if (flag == 0 || flag == 1) currIndex++;
      else ++currIndex;
    }
